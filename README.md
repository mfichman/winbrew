...
Download and install [Microsoft Visual Studio 2026](http://www.visualstudio.com/),
...
Open the Visual Studio 2026 x64 Native Tools command prompt, then type:
